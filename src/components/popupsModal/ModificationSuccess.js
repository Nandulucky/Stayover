...
class ModificationSuccess extends Component {
  state = {
    modalVisible: false
  };
  constructor(props) {
  ...
  setModalVisible(visible) {
    this.props.modalModificationSuccess = false;
  }
    ...
    return (
      <View style={{ marginTop: 22 }}>
        <Modal
          animationType="fade"
          transparent={false}
          visible={this.props.modalModificationSuccess}
          // onRequestClose={() => {
          ...
          <View style={styles.container}>
            ...
            <View style={{ alignItems: "center", marginTop: 20 }}>
              ...
              <Text style={{ ...styles.textFooter, marginHorizontal: "5%" }}>
                ...
                nights has been Modified. The Refund has been Initiated.
              </Text>
